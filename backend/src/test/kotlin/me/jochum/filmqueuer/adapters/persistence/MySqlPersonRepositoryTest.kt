...
class MySqlPersonRepositoryTest {
    ...
    @Test
    fun `save should store person in database`() = runBlocking {
        // Given
        val person = Person(
            tmdbId = 123,
            name = "John Doe",
    ...
    @Test
    fun `save should ignore duplicate tmdbId`() = runBlocking {
        // Given
        val person1 = Person(
            tmdbId = 123,
            name = "John Doe",
    ...
    @Test
    fun `findByTmdbId should return null when person not found`() = runBlocking {
        // When
    ...
    @Test
    fun `findAll should return all saved persons`() = runBlocking {
        // Given
    ...
    @Test
    fun `findAll should return empty list when no persons exist`() = runBlocking {
        // When
        val allPersons = repository.findAll()
    ...
    @Test
    fun `deleteByTmdbId should remove person and return true`() = runBlocking {
        // Given
    ...
    @Test
    fun `deleteByTmdbId should return false when person not found`() = runBlocking {
        // When
    ...
    @Test
    fun `should handle all department types correctly`() = runBlocking {
        // Given
        val persons = listOf(
