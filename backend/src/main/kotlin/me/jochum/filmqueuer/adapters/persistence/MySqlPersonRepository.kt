...
class MySqlPersonRepository : PersonRepository {
    ...
    override suspend fun save(person: Person): Person = newSuspendedTransaction {
    ...
    override suspend fun findByTmdbId(tmdbId: Int): Person? = newSuspendedTransaction {
    ...
    override suspend fun findAll(): List<Person> = newSuspendedTransaction {
    ...
    override suspend fun deleteByTmdbId(tmdbId: Int): Boolean = newSuspendedTransaction {
